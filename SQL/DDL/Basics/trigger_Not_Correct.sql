...
ALTER TABLE update_log2 ADD COLUMN old_name varchar(200);
...
FOR EACH ROW
BEGIN
INSERT INTO update_log2(CusId,name,action,log_time,old_name) VALUES (new.id,new.name,'update',Now(),old.name);
